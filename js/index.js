...
app.controller('MapCtrl', function($scope,$http) {
    ...
    <!--Arreglo que contiene objetos. Cada objeto tiene las propiedades nombre, descripción, latitud y longitud-->
   $scope.cities = [
    {
...
$scope.initialise = function() {
    ...
    $scope.guardarJSON = function () {
			$scope.descargar = '';  /*El archivo tiene un nombre en blanco para llenarlo desde HTML*/
